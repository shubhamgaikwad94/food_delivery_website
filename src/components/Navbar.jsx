...
let items = useSelector(state => state.cart.items);
  ...
  return (
    <div className='w-full h-[100px] flex justify-between items-center px-5 md:px-8 '>
      <div className='w-[60px] h-[70px] bg-white flex justify-center items-center rounded-md shadow-xl'>
      <MdFastfood className='w-[30px] h-[30]px text-green-500' />
      </div>
      ...
      <FaShoppingBag className='w-[30px] h-[30]px text-green-500'/>
